...
task.spawn(function()
    ...
    local screenGui = parentGui:WaitForChild("DSHUB_V1_0", 5)
    if not screenGui then return end

    while screenGui.Parent do
        for _, object in ipairs(screenGui:GetDescendants()) do
            if object:IsA("TextLabel") and object.Text == "DS Hub" then
                object.TextColor3 = Color3.fromRGB(0, 255, 100)
            end
        end
        task.wait(0.1)
    end
...
library.AutoFarm = {
    ...
    TeleportLoader = [[
    loadstring(game:HttpGet("https://raw.githubusercontent.com/devscripterbr-gif/biblioteca-modular-/refs/heads/main/DSHUB.lua?cb=" .. tostring(os.time())))()
]],
    Running = false,
